<%@ Page Title="Mestre Agil WEB - Soluções Acadêmicas e Financeiras" Language="C#"
    ...
    Inherits="ProtocoloAgil.pages.CadastroStatusCliente" CodeBehind="CadastroStatusCliente.aspx.cs" %>

<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="Server">
    <script type="text/javascript">
        function GetConfirm() {
            var hf = document.getElementById("<%# HFConfirma.ClientID %>");
            if (confirm("Deseja realmente excluir este status de cliente?") == true)
                hf.value = "true";
            else
                hf.value = "false";
        }
    ...
    <asp:Panel ID="Panel1" runat="server" CssClass=" Table centralizar">
        <div class="breadcrumb">
            <p style="text-align: left;">
                Configurações > <span>Status Cliente</span></p>
        </div>
        <div class="controls">
            ...
            <asp:View ID="View1" runat="server">
                <asp:Panel ID="Panel3" runat="server" Height="420px" Width="100%">
                    ...
                    <asp:UpdatePanel ID="UpdatePanel1" runat="server" UpdateMode="Conditional">
                        <ContentTemplate>
                            <asp:GridView OnRowDataBound="GridView1_RowDataBound" ID="GridView1" runat="server" AllowPaging="True" CssClass="list_results"
                                ...
                                <Columns>
                                    <asp:BoundField DataField="StcCodigo" HeaderText="Código" InsertVisible="False" ReadOnly="True"
                                        SortExpression="Tco_Codigo">
                                        <HeaderStyle Width="10%" />
                                    </asp:BoundField>
                                    <asp:BoundField DataField="StcDescricao" HeaderText="Descrição" SortExpression="StcDescricao">
                                    ...
                                    <asp:TemplateField HeaderText="Excluir">
                                        <ItemTemplate>
                                            <asp:ImageButton ID="IMBexcluir" CommandArgument='<%# DataBinder.Eval(Container.DataItem, "StcCodigo")%>'
