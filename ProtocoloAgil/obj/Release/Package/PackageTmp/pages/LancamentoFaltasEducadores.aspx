<%@ Page Title="" Language="C#" MasterPageFile="~/MaEducador.Master" AutoEventWireup="true" CodeBehind="LancamentoFaltasEducadores.aspx.cs" Inherits="ProtocoloAgil.pages.LancamentoFaltasEducadores" %>
            ...
            <div class="List_results">
                ...
                <table align="center" class="auto-style1">
                    ...
                    <tr>
                        ...
                        <td align="left" class="auto-style2">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; Disciplina:</td>
                    ...
                    <tr>
                        ...
                        <td>
                            <asp:DropDownList ID="DDDisciplina" runat="server" AppendDataBoundItems="True" AutoPostBack="true" CssClass="fonteTexto" DataTextField="DisDescricao" DataValueField="DisCodigo" OnSelectedIndexChanged="DDDisciplina_SelectedIndexChanged" Height="18px" ViewStateMode="Enabled" Width="90%">
                            </asp:DropDownList>
                        </td>
            ...
            <div class="List_results">
                ...
                <table align="center" class="auto-style1">
                    ...
                    <tr>
                        ...
                        <td>
                            <asp:DropDownList ID="DDDisciplinaLancamento" runat="server" AppendDataBoundItems="True" AutoPostBack="true" CssClass="fonteTexto" DataTextField="DisDescricao" DataValueField="DisCodigo" OnSelectedIndexChanged="DDDisciplinaLancamento_SelectedIndexChanged" Height="18px" ViewStateMode="Enabled" Width="90%">
                            </asp:DropDownList>
                        </td>
