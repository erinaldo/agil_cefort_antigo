<%@ Page Title="" Language="C#" MasterPageFile="~/MPusers.Master" AutoEventWireup="true" CodeBehind="TotalAulasParceiro.aspx.cs" Inherits="ProtocoloAgil.pages.TotalAulasParceiro" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    <div class="breadcrumb">
        <p style="text-align: left;">
            Aprendiz > <span>Total Aulas de Parceiro por Período</span>
        </p>
    </div>
        ...
        <asp:View ID="View1" runat="server">
            <div class="centralizar" style="width: 98%; margin: 0 auto;">
                <div class="text_titulo">
                    <h1>Total Aulas de Parceiro por Período</h1>
                </div>
                <br />
                <div class="controls FundoPainel">
                    <table class="centralizar  FundoPainel" style="width: 98%; height: 52px;">
                        <tr>
                            <td class="auto-style1"><span class="fonteTab">Parceiro:&nbsp;</span>
                                <asp:DropDownList ID="DD_Parceiro" runat="server" CssClass="fonteTab" Height="16px"
                                    DataSourceID="SDS_Parceiro" OnDataBound="IndiceZero" DataTextField="ParDescricao"
                                    DataValueField="ParCodigo" Width="416px">
                                </asp:DropDownList>
                ...
                <ContentTemplate>
                    ...
                    <asp:Panel ID="pn_info" runat="server" CssClass="centralizar" Height="100px" Visible="false"
                        ...
                        <div class="text_titulo" style="margin-top: 30px;">
                            <h1>Não existem presenças para esse Parceiro/Período.</h1>
                        </div>
                    </asp:Panel>
                    <asp:Panel ID="PanelLegenda" runat="server" Visible="false" Height="80px">
                        <div class="text_titulo" style="font-size: 12px; margin-left: 25px;">
                            ...
                            <span style="color: silver">Justificadas</span> &nbsp;|&nbsp;
