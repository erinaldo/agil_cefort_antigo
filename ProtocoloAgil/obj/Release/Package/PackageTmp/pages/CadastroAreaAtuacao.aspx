    ...
    <asp:Panel ID="Panel1" runat="server" CssClass=" Table centralizar">
        <div class="breadcrumb">
            <p style="text-align: left;">
                Configurações > <span>Cadastro de Área de Atuação</span></p>
        </div>
        <div class="controls">
            ...
            <table class="Table FundoPainel" style="width: 70%; margin: 0 auto;">
                    <tr>
                        <td class="cortitulo corfonte titulo" style="font-size: large;">
                          Cadastro de Áreas de Atuação</td>
                    </tr>
                    ...
                    <tr>
                      ...
                      <tr>
                          <td class="fonteTab Tam05">
                              &nbsp;</td>
                          <td class="fonteTab Tam08" style="text-align: left;">
                              Código</td>
                          <td class=" Tam40 fonteTab" style="text-align: left;">
                              &nbsp;&nbsp; Nome da Área de Atuação</td>
                      ...
                      <tr>
                          ...
                          <td class="fonteTab" style="text-align: left;">
                              &nbsp;&nbsp;<asp:TextBox ID="TB_carga_horaria" runat="server" CssClass="fonteTexto" onkeyup = "formataInteiro(this,event);"
                                  MaxLength="2" style=" width: 60px; height: 14px;"> </asp:TextBox>
                          </td>
                          <td class="fonteTab" style="text-align: left;">
                           <asp:TextBox ID="TB_CBO" runat="server" CssClass="fonteTexto" MaxLength="10" 
                                style=" width: 80%; height: 14px;"></asp:TextBox>
                        </td>
                      </tr>
                      <tr>
