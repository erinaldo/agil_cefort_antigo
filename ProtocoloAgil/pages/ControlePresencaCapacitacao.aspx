<%@ Page Title="" Language="C#" MasterPageFile="~/MPusers.Master" AutoEventWireup="true" CodeBehind="ControlePresencaCapacitacao.aspx.cs" Inherits="ProtocoloAgil.pages.ControlePresencaCapacitacao" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    <div class="breadcrumb">
        <p style="text-align: left;">
            Aprendiz > <span>Controle de Presença por Data/Turma Capacitação</span>
        </p>
    </div>
        ...
        <asp:View ID="View1" runat="server">
            <div class="centralizar" style="width: 98%; margin: 0 auto;">
                <div class="text_titulo">
                    <h1>Controle de Presença por Data/Turma Capacitação</h1>
                </div>
                <br />
                        ...
                        <tr>
                            <td><span class="fonteTab">Turma:&nbsp;</span>
                                ...
                                <asp:SqlDataSource ID="SDS_Turma" runat="server" ConnectionString="<%$ ConnectionStrings:ProtocoloAgilConnectionString %>"
                                    SelectCommand="SELECT TurCodigo, TurNome FROM CA_Turmas where TurCurso = '003' ORDER BY TurNome"></asp:SqlDataSource>
                            </td>
                            ...
                            <td>
                                ...
                                <asp:Button ID="btnConteudo" runat="server" CssClass="btn_novo" Text="Conteúdo" Visible="false" OnClick="btnConteudo_Click" />
                            </td>
                        </tr>
                    </table>
                </div>
            ...
            <asp:UpdatePanel ID="UpdatePanel1" runat="server">
                <ContentTemplate>
                    ...
                    <asp:GridView ID="GridView1" runat="server" AllowPaging="True" PageSize="18" AutoGenerateColumns="False"
                        CaptionAlign="Top" CssClass="list_results" HorizontalAlign="Center" Style="width: 70%; margin: auto"
                        DataSourceID="SDSControlePresenca"
                        ...
                        <Columns>
                            ...
                            <asp:BoundField DataField="acpPresenca" HeaderText="Presença" SortExpression="acpPresenca">
