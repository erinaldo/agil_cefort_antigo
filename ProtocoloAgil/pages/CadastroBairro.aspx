<%@ Page Title="Mestre Agil WEB - Soluções Acadêmicas e Financeiras" Language="C#"
    ...
    Inherits="ProtocoloAgil.pages.CadastroBairro" CodeBehind="CadastroBairro.aspx.cs" %>

<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="Server">
    <script type="text/javascript">
        function GetConfirm() {
            var hf = document.getElementById("<%# HFConfirma.ClientID %>");
            if (confirm("Deseja realmente excluir este bairro?") == true)
                hf.value = "true";
            else
                hf.value = "false";
        }
    ...
    <asp:Panel ID="Panel1" runat="server" CssClass=" Table centralizar">
        <div class="breadcrumb">
            <p style="text-align: left;">
                Configurações > <span>Cadastro de Bairros</span></p>
        </div>
        <div class="controls">
                        ...
                        <Columns>
                            ...
                            <asp:CommandField ButtonType="Image" HeaderText="Alterar" SelectImageUrl="~/images/icon_edit.png"
                             ...
                             <asp:TemplateField HeaderText="Excluir">
                                <ItemTemplate>
                                    <asp:ImageButton ID="IMBexcluir"  CommandArgument ='<%# DataBinder.Eval(Container.DataItem, "Bairro")%>' 
                ...
                <table class="Table FundoPainel">
                    <tr>
                        <td class="cortitulo corfonte titulo" colspan="4" style="font-size: large;">
                            <asp:Label ID="LBtituloAlt" runat="server" Text="Cadastro de Bairros"></asp:Label>
                        </td>
                    </tr>
                      <tr>
                    ...
                    <tr>
                     <td class="Tam05" style="text-align: left">
                        ...
                        <td class="Tam50" style="text-align: left">
                            <asp:TextBox ID="TBBairro_nome" runat="server"  CssClass="fonteTexto" Height="13px" MaxLength="40" Width="90%"></asp:TextBox>
                            &nbsp;
                            </td>
                    ...
                    <tr>
                     <td class="Tam05" style="text-align: left">
                        ...
                        <td class="Tam18" style="text-align: left">
                              <asp:DropDownList ID="DD_regiao" OnDataBound="IndiceZero" runat="server" CssClass="fonteTexto"  DataTextField="DescRegiao" DataValueField="CodRegiao"
                                  Height="18px" onkeydown="ModifyEnterKeyPressAsTab();" Width="80%">
