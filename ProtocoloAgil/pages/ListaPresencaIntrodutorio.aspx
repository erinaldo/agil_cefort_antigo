<%@ Page Title="" Language="C#" MasterPageFile="~/MPusers.Master" AutoEventWireup="true" CodeBehind="ListaPresencaIntrodutorio.aspx.cs" Inherits="ProtocoloAgil.pages.ListaPresencaIntrodutorio" %>
     ...
     <asp:Panel ID="Panel1" runat="server" CssClass=" Table centralizar">
        <div class="breadcrumb">
            <p style="text-align: left;">
                Pedagógico > <span>Lista de Presença Introdutório</span></p>
        </div>
        <div class="List_results">
            ...
            <table align="center" class="auto-style1">
                ...
                <tr>
                    ...
                    <td align="left">
                        &nbsp;<asp:DropDownList ID="DD_Data" runat="server" DataTextField="AdiDataAula" DataValueField="AdiDataAula" DataTextFormatString="{0:dd/MM/yyyy}">
                        </asp:DropDownList>
                    </td>
                </tr>
                <tr>
