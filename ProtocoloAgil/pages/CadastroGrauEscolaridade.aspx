<%@ Page Title="Mestre Agil WEB - Soluções Acadêmicas e Financeiras" Language="C#"
    AutoEventWireup="true" MasterPageFile="~/MPusers.Master" Inherits="ProtocoloAgil.pages.CadastroGrauEscolaridade"
    CodeBehind="CadastroGrauEscolaridade.aspx.cs" %>

<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="Server">
    <script type="text/javascript">
        function GetConfirm() {
            var hf = document.getElementById("<%# HFConfirma.ClientID %>");
            if (confirm("Deseja realmente excluir esta escolaridade ?") == true)
                hf.value = "true";
            else
                hf.value = "false";
        }
    ...
    <asp:Panel ID="Panel1" runat="server" CssClass=" Table centralizar">
        <div class="breadcrumb">
            <p style="text-align: left;">
                Configurações > <span>Tabela de Graus de Escolaridade</span></p>
        </div>
        <div class="controls">
            <div style="float: left;">
                ...
                <asp:Button ID="btn_texto" runat="server" CssClass="btn_controls" Text="Arquivo de Texto"
                ...
                <asp:UpdatePanel ID="UpdatePanel1" runat="server" UpdateMode="Conditional">
                    <ContentTemplate>
                        <asp:GridView ID="GridView1" runat="server" AllowPaging="True" CssClass="list_results"
                            ...
                            Style="width: 60%; margin: 0 auto" HorizontalAlign="Center" OnSelectedIndexChanged="GridView1_SelectedIndexChanged"
                            OnPageIndexChanging="GridView1_PageIndexChanging" CellPadding="4" ForeColor="#333333" GridLines="None">
                            <AlternatingRowStyle BackColor="White" ForeColor="#284775" />
                            <Columns>
                                <asp:BoundField DataField="GreCodigo" HeaderText="Código" InsertVisible="False" ReadOnly="True"
                                    SortExpression="GreCodigo">
                                    <HeaderStyle Width="10%" />
                                </asp:BoundField>
                                <asp:BoundField DataField="GreDescricao" HeaderText="Grau de Escolaridade" SortExpression="GreDescricao">
                                ...
                                <asp:TemplateField HeaderText="Excluir">
                                    <ItemTemplate>
                                        <asp:ImageButton ID="IMBexcluir" CommandArgument='<%# DataBinder.Eval(Container.DataItem, "GreCodigo")%>'
                            ...
                            <table class="Table FundoPainel">
                                <tr>
                                    <td class="cortitulo corfonte titulo" colspan="6" style="font-size: large;">
                                        Cadastro de Grau de Escolaridade
                                    </td>
                                </tr>
                                <tr>
                                ...
                                <tr>
                                    ...
                                    <td class="Tam15" style="text-align: left">
                                        <asp:TextBox ID="TBcodigo" runat="server" CssClass="fonteTexto" MaxLength="3" Style="width: 60%;
                                ...
                                <tr>
                                    ...
                                    <td style="text-align: left" colspan="4">
                                        <asp:TextBox ID="TBNome" runat="server" CssClass="fonteTexto" MaxLength="30" Style="width: 70%;
                                            height: 13px;"></asp:TextBox>
                                    </td>
                                </tr>
                                <tr>
