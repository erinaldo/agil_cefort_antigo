                    ...
                    <tr>
                        <td colspan="4">
                            <span class="fonteTexto">
                                <strong>E</strong> - Empresa. &nbsp;<strong>P</strong> - Presença.
                            </span>
                        </td>
                    </tr>
                    <tr>
                                    ...
                                    <asp:GridView ID="gvAlunos" runat="server" Width="580px" CssClass="list_results" AutoGenerateColumns="False" DataKeyNames="CodAprendiz,CodTurma,Turma,Data" CellPadding="4" ForeColor="#333333" GridLines="None">
                                        ...
                                        <Columns>
                                            ...
                                            <asp:TemplateField HeaderText="Presença">
                                                <ItemTemplate>
                                                    <asp:TextBox ID="TBPresenca" runat="server" Height="16px" Text='<%# Bind("Presenca") %>' Width="20px" onkeyup="FormataFaltaJustificadoEmpresa(this,event);" MaxLength="1"></asp:TextBox>
                                                </ItemTemplate>
