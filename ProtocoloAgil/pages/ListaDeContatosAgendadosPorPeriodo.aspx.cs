...
{
    public partial class ListaDeContatosAgendadosPorPeriodo : Page
    {
        ...
        protected void GridView1_RowDataBound(object sender, GridViewRowEventArgs e)
        {
            if (e.Row.RowType == DataControlRowType.DataRow)
            {
                ...
                {
                    e.Row.Cells[6].BackColor = Color.FromName("red");
                }

                if (e.Row.Cells[7].Text.Equals("2"))
                {
                    e.Row.Cells[6].BackColor = Color.FromName("green");
                }

                if (e.Row.Cells[7].Text.Equals("3"))
                {
                    e.Row.Cells[6].BackColor = Color.FromName("blue");
                }

                if (e.Row.Cells[7].Text.Equals("4"))
                {
                    e.Row.Cells[6].BackColor = Color.FromName("yellow");
                }

                if (e.Row.Cells[7].Text.Equals("5"))
                {
                    e.Row.Cells[6].BackColor = Color.FromName("black");
                }
                if (e.Row.Cells[7].Text.Equals("6"))
                {
                    e.Row.Cells[6].BackColor = Color.FromName("gray");
                }
