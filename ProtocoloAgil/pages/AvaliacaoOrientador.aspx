<%@ Page Title="" Language="C#" MasterPageFile="~/MPUsers.Master" AutoEventWireup="true"
    CodeBehind="AvaliacaoOrientador.aspx.cs" Inherits="ProtocoloAgil.pages.AvaliacaoOrientador" %>
     ...
     <div class="text_titulo">
                <h1> Avaliações Disponíveis Educadores</h1>
                   ...
                   <div class="cadastro_pesquisa" style="height: 70px;width:98%; margin: 30px 1% 10px 1%; border: 1px solid #7f7f7f">
                    ...
                    <div class="linha_cadastro" style="width: 100%; text-align: right;float:right;">
