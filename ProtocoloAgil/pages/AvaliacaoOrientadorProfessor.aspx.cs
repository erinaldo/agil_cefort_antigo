...
{
    public partial class AvaliacaoOrientadorProfessor : Page
    {
        ...
        private void BindGridview()
        {
            ...
            var sqlgeral = "SELECT  PepCodigo, Apr_Codigo,Apr_Nome, ParCodigo,ParNomeFantasia, PesNome, ParUniDescricao, ParUniCodigoParceiro, PepRealizada, PepAno, PepMes = CASE WHEN PepMes = 1 THEN 'Janeiro' WHEN PepMes = 2 THEN 'Fevereiro' " +
                            ...
                            "left join CA_Orientador ON PepOrientador = "+Session["codigo"]+" left join CA_Usuarios on UsuCodigo = ParRespFundacao " +
                            "WHERE PepRealizada = 'N' and PepOrientador = " + Session["codigo"] + " ";
            ...
            if (!DDTurmaCapacitacao.SelectedValue.Equals(string.Empty))
                sqlgeral += " AND Apr_TurmaENC = " + DDTurmaCapacitacao.SelectedValue;
