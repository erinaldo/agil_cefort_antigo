...
{
    public partial class TotalAulasParceiro : System.Web.UI.Page
    {
        ...
        private void CarregarGrid(int pParceiro, DateTime startDate, DateTime endDate)
        {
            ...
            using (SqlConnection connection = new SqlConnection(GetConfig.Config()))
            {
                ...
                SqlCommand command =
                    new SqlCommand(
                       @"SELECT View_ControlePresenca.Apr_Codigo, 
                                ...
                                Sum(Case when AdiPresenca = 'J' then 1 else 0 end) AS Justificadas,
                                Sum(Case when AdiPresenca = 'F' then 1 else 0 end) AS Faltas
                ...
                while (results.Read())
                {
                    ...
                    string justificadas = results.GetInt32(7).ToString();
                    string faltas = results.GetInt32(8).ToString();
                    ...
                    if (!dates.Contains(date))
                    {
                        ...
                        fields.Add(new TemplateField()
                        {
                            ...
                            HeaderText = "<center>" + date + "<br /> A | P | J | F</center>"
                        });
                    }
                    row[date] = "<center><b><span style='color: blue;'>" + aulas + "</span> | <span style='color: green;'>" + presencas + "</span> | <span style='color: silver;'>" + justificadas + "</span> | <span style='color: red;'>" + faltas + "</span></b></center>";
                    dt.AcceptChanges();
                }
        ...
        protected void btn_pesquisa_Click(object sender, EventArgs e)
        {
            ...
            CarregarGrid(Convert.ToInt32(DD_Parceiro.SelectedValue), Convert.ToDateTime(tb_data_inicial.Text), Convert.ToDateTime(tb_data_final.Text));
        ...
        {
            string FileName = String.Format("TotalAulasParceiro-{0}_{1}.xls",
