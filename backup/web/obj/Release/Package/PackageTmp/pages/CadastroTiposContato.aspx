<%@ Page Title="Mestre Agil WEB - Soluções Acadêmicas e Financeiras" Language="C#"
    ...
    Inherits="ProtocoloAgil.pages.CadastroTiposContato" CodeBehind="CadastroTiposContato.aspx.cs" %>

<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="Server">
    <script type="text/javascript">
        function GetConfirm() {
            var hf = document.getElementById("<%# HFConfirma.ClientID %>");
            if (confirm("Deseja realmente excluir este tipo de contato?") == true)
                hf.value = "true";
            else
                hf.value = "false";
        }
    ...
    <asp:Panel ID="Panel1" runat="server" CssClass=" Table centralizar">
        <div class="breadcrumb">
            <p style="text-align: left;">
                Configurações > <span>Tipos Contatos</span></p>
        </div>
        <div class="controls">
                    ...
                    <asp:UpdatePanel ID="UpdatePanel1" runat="server" UpdateMode="Conditional">
                        <ContentTemplate>
                            <asp:GridView ID="GridView1" runat="server" AllowPaging="True" CssClass="list_results"
                                ...
                                <Columns>
                                    <asp:BoundField DataField="Tco_Codigo" HeaderText="Código" InsertVisible="False" ReadOnly="True"
                                        SortExpression="Tco_Codigo">
                                        <HeaderStyle Width="10%" />
                                    </asp:BoundField>
                                    <asp:BoundField DataField="Tco_Descricao" HeaderText="Descrição" SortExpression="Tco_Descricao">
                                    ...
                                    <asp:TemplateField HeaderText="Excluir">
                                        <ItemTemplate>
                                            <asp:ImageButton ID="IMBexcluir" CommandArgument='<%# DataBinder.Eval(Container.DataItem, "Tco_Codigo")%>'
