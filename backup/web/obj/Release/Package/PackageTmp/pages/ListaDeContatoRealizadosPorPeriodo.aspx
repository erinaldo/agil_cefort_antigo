<%@ Page Title="Mestre Agil WEB - Soluções Acadêmicas e Financeiras" Language="C#"
    ...
    Inherits="ProtocoloAgil.pages.ListaDeContatoRealizadosPorPeriodo" CodeBehind="ListaDeContatoRealizadosPorPeriodo.aspx.cs" %>
    ...
    <asp:Panel ID="Panel1" runat="server" CssClass="Table">
        <div class="breadcrumb">
            <p style="text-align: left;">
                Configurações > <span>Lista contatos realizados</span>
            </p>
        </div>
        <div class="linha">
    ...
    <div class="formatoTela_02">
        <asp:MultiView ID="MultiView1" runat="server" ActiveViewIndex="0">
            <asp:View ID="View1" runat="server">
                ...
                <h1>
                    Lista de contatos realizados por período
                ...
                <asp:UpdatePanel ID="UpdatePanel1" runat="server" UpdateMode="Conditional">
                    <ContentTemplate>
                        <asp:GridView ID="GridView1" runat="server" AllowPaging="True"
                            ...
                            Style="width: 75%; margin: auto" OnRowDataBound="GridView1_RowDataBound" HorizontalAlign="Center" EmptyDataText="Não existe registros cadastrados"  EmptyDataRowStyle-HorizontalAlign="Center" EmptyDataRowStyle-BackColor="Silver"
                            ...
                            <Columns>
                                ...
                                <asp:BoundField DataField="cocDataContato" HeaderText="Data Contato" DataFormatString="{0:dd/MM/yyyy}" SortExpression="cocDataContato">
                                 ...
                                 <asp:BoundField DataField="CocDatafechamento" HeaderText="Data Fechamento" DataFormatString="{0:dd/MM/yyyy}" SortExpression="CocDatafechamento">
                                    <ItemStyle HorizontalAlign="Left" VerticalAlign="Middle" />
                                </asp:BoundField>
