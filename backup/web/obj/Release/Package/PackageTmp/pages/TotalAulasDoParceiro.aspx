<%@ Page Title="" Language="C#" MasterPageFile="~/MaParceiro.Master" AutoEventWireup="true" CodeBehind="TotalAulasDoParceiro.aspx.cs" Inherits="ProtocoloAgil.pages.TotalAulasDoParceiro" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    <div class="breadcrumb">
        <p style="text-align: left;">
            Aprendiz > <span>Total Aulas por Período</span>
        </p>
    </div>
                ...
                <ContentTemplate>
                    ...
                    <asp:Panel ID="PanelLegenda" runat="server" Visible="false" Height="80px">
                        <div class="text_titulo" style="font-size: 12px; margin-left: 25px;">
                            ...
                            <span style="color: red">Faltas</span>  &nbsp;|&nbsp; 
                            <span style="color: black">Faltas Justificadas</span>
                            </b>
                        </div>
                    </asp:Panel>
                    <asp:Panel runat="server" CssClass="centralizar" ID="pn_grid" Width="98%">
                        ...
                        <asp:GridView ID="GridView1" runat="server" Style="margin: 0 auto; width: 100%; text-align: left;"
                            ...
                            <EmptyDataTemplate>
                                <center>
                                    <div class="text_titulo" style="margin-bottom: 30px;">
